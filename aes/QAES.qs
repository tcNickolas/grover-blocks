...
namespace QAES
{
    ...
    operation ByteSub(input_state: Qubit[][], ancilla: Qubit[][], costing: Bool) : Unit is Adj
    {
        for i in 0 .. 3
        {
            for j in 0 .. 3
    ...
    operation SubByte(input_word: Qubit[], ancilla: Qubit[], costing: Bool) : Unit is Adj
    {
        for i in 0 .. 3
        {
...
namespace QAES.Widest
{
    open Microsoft.Quantum.Intrinsic;
    open QUtilities;
    operation AddRoundKey(state: Qubit[][], round_key: Qubit[]) : Unit is Adj
    {
        for j in 0 .. 3
        {
            for i in 0 .. 31
    ...
    operation KeyExpansion(key: Qubit[], Nr: Int, Nk: Int, costing: Bool) : Unit is Adj
    {
        // First stage of expansion is copying the AES key into the expanded key
        // this is unneeded, we just allocate qubits for the whole expanded key
    ...
    operation Round(in_state: Qubit[][], out_state: Qubit[][], key: Qubit[], round: Int, costing: Bool) : Unit is Adj
    {
    ...
    operation FinalRound(in_state: Qubit[][], out_state: Qubit[][], key: Qubit[], Nr: Int, costing: Bool) : Unit is Adj
    {
        QAES.ByteSub(in_state, out_state, costing);
        QAES.InPlace.ShiftRow(out_state, costing);
    ...
    operation ForwardRijndael(expanded_key: Qubit[], state: Qubit[], ciphertext: Qubit[], Nr: Int, Nk: Int, costing: Bool) : Unit is Adj
    {
    ...
    operation Rijndael(expanded_key: Qubit[], state: Qubit[], ciphertext: Qubit[], Nr: Int, Nk: Int, costing: Bool) : Unit is Adj
    {
...
namespace QAES.SmartWide
{
    ...
    // round values start from 1 to Nr-1, since the final round Nr has a different shape
    operation Round(in_state: Qubit[][], out_state: Qubit[][], key: Qubit[], round: Int, Nk: Int, in_place_mixcolumn: Bool, costing: Bool) : Unit is Adj
    {
    ...
    operation FinalRound(in_state: Qubit[][], out_state: Qubit[][], key: Qubit[], round: Int, Nk: Int, costing: Bool) : Unit is Adj
    {
        QAES.ByteSub(in_state, out_state, costing);
        QAES.InPlace.ShiftRow(out_state, costing);
        if (Nk == 4)
    ...
    operation ForwardRijndael(key: Qubit[], state: Qubit[], Nr: Int, Nk: Int, in_place_mixcolumn: Bool, costing: Bool) : Unit is Adj
    {
        // "round 0"
    ...
    operation Rijndael(key: Qubit[], state: Qubit[], ciphertext: Qubit[], Nr: Int, Nk: Int, in_place_mixcolumn: Bool, costing: Bool) : Unit is Adj
    {
    ...
    operation ForwardGroverOracle(other_keys: Qubit[], state_ancillas: Qubit[], key_superposition: Qubit[], success: Qubit, plaintext: Qubit[], target_ciphertext: Bool[], pairs: Int, Nr: Int, Nk: Int, in_place_mixcolumn: Bool, costing: Bool) : Unit is Adj
    {
        // copy loaded key
        for i in 0..(pairs-2)
        {
...
namespace QAES.InPlace
{
    ...
    operation ShiftRow(state: Qubit[][], costing: Bool) : Unit is Adj
    {
    ...
    operation MixWord(word: Qubit[], costing: Bool) : Unit is Adj
    {
        // U
        CNOT(word[7], word[0]);
        CNOT(word[8], word[0]);
    ...
    operation MixColumn(state: Qubit[][], costing: Bool) : Unit is Adj
    {
        for j in 0 .. 3
        {
    ...
    operation RotByte(word: Qubit[], costing: Bool) : Unit is Adj
    {
        for i in 0 .. 2
        {
    ...
    operation KeyExpansion(key: Qubit[], kexp_round: Int, Nk: Int, first_word: Int, last_word: Int, costing: Bool) : Unit is Adj
    {
