...
namespace QGF256
{
    ...
    operation Mul(a : Qubit[], b: Qubit[], res: Qubit[], costing: Bool) : Unit is Adj
    {
        // construct e
        for i in 0..6
        {
    ...
    /// <param name="res">Output register</param>
    /// <returns>Unit</returns>
    operation UnrolledMul(a : Qubit[], b: Qubit[], res: Qubit[], costing: Bool) : Unit is Adj
    {
        //  construct e
    ...
    /// <returns>Unit</returns>
    operation Square(a: Qubit[], b: Qubit[]) : Unit is Adj
    {
        CNOT(a[0], b[0]);
        CNOT(a[4], b[0]);
        CNOT(a[6], b[0]);
    ...
    /// <param name="b">Output register</param>
    /// <returns>Unit</returns>
    operation Fourth(a: Qubit[], b: Qubit[]) : Unit is Adj
    {
        CNOT(a[0], b[0]);
        CNOT(a[2], b[0]);
        CNOT(a[3], b[0]);
    ...
    /// <param name="b">Output register</param>
    /// <returns>Unit</returns>
    operation Sixteenth(a: Qubit[], b: Qubit[], costing: Bool) : Unit is Adj
    {
    ...
    /// <returns>Unit</returns>
    operation Inverse(a: Qubit[], b: Qubit[], costing: Bool) : Unit is Adj
    {
...
namespace QGF256.InPlace {
    ...
    /// <returns>Unit</returns>
    operation Square(a: Qubit[], costing: Bool) : Unit is Adj
    {
        // U
        CNOT(a[4], a[0]);
        CNOT(a[6], a[0]);
    ...
    /// <param name="a">Input/Output register</param>
    /// <returns>Unit</returns>
    operation Fourth(a: Qubit[], costing: Bool) : Unit is Adj
    {
    ...
    /// <param name="a">Input/Output register</param>
    /// <returns>Unit</returns>
    operation SixtyFourth(a: Qubit[], costing: Bool) : Unit is Adj
    {
        CNOT(a[1], a[0]);
        CNOT(a[6], a[0]);
        CNOT(a[2], a[1]);
...
namespace GLRS16
{
    ...
    operation SBox(a: Qubit[], b: Qubit[], costing: Bool) : Unit is Adj
    {
